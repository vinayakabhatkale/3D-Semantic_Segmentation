...
class modproftTracker(SegmentationTracker):
    def __init__(self, dataset, stage: str = "train", wandb_log: bool = False, use_tensorboard: bool = False, dataset_opt: dict=None):
        ...
        """
        super(modproftTracker, self).__init__(dataset=dataset, stage=stage, wandb_log=wandb_log, use_tensorboard=use_tensorboard, dataset_opt=dataset_opt)
